    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visitor_middle_name', models.CharField(blank=True, max_length=50, null=True)),
                ('phone', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='passes.department')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='passes.employee')),
